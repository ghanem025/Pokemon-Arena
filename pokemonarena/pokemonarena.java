...
//    
    ...
    {
      enemypick = (int) (Math.random()*allPoke.size())-4;
      System.out.println("enemy turn");
      int enemyattack = enemypick;
...
//  
  ...
  public static void main (String [] args) throws IOException{
    ...
    load();
    pick4();
    enemypick = (int) (Math.random()*allPoke.size());
   
    badP = allPoke.get(enemypick);
    battle(badP);
